...
@user_bot.on_message(filters.command("bulkadd") & filters.private)
...
async def generate_telethon_session(client, message):
    ...
    try:
        ...
        await status_message.edit_text(
            ...
            f"Please enter the code you received by either:\n""\n
            f"1. Simply sending the code directly as a message (e.g., 12345), OR\n""\n
            f"2. Using the command format:\n"
            f"/entercode 12345\n\n"
...
@user_bot.on_callback_query(filters.regex("^admin_clear_inventory$"))
...
@user_bot.on_callback_query(filters.regex("^copy_binance_id$"))
...
# Try to restart telethon_user_data on bot start
try:
    with open('telethon_data.pickle', 'rb') as f:
        telethon_user_data = pickle.load(f)
    print('Loaded telethon_user_data from file')
except Exception as e:
    telethon_user_data = {}
    print(f'Failed to load telethon_user_data: {e}')

# Function to save telethon_user_data
def save_telethon_data():
    try:
        with open('telethon_data.pickle', 'wb') as f:
            pickle.dump(telethon_user_data, f)
        print('Saved telethon_user_data to file')
    except Exception as e:
        print(f'Failed to save telethon_user_data: {e}')
