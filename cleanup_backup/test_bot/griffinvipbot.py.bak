...
db = client["telegram_test_bot"]  # Using a new database name to avoid lock conflicts
users = db["users"]
orders = db["orders"]
...
SESSIONS_DIR = "test_bot/sessions"
        ...
        async def handle_new_message(event):
            try:
                ...
                if is_otp:
                    ...
                    if current_owner:
                        try:
                            await griffin_bot.send_message(
...
# --- Command Handlers ---
@griffin_bot.on_message(filters.command("start"))
...
@griffin_bot.on_message(filters.command("help"))
...
@griffin_bot.on_message(filters.command("mynumbers") & filters.private)
...
@griffin_bot.on_message(filters.command("id") & filters.private)
...
@griffin_bot.on_callback_query(filters.regex("^main_menu$"))
...
@griffin_bot.on_callback_query(filters.regex("^buy_number$"))
...
@griffin_bot.on_callback_query(filters.regex("^buy_telegram$"))
...
@griffin_bot.on_callback_query(filters.regex("^(ind|bd|usa|ng|other)_(regular|vip)$"))
...
@griffin_bot.on_callback_query(filters.regex("^confirm_[a-z]+_(regular|vip)$"))
...
@griffin_bot.on_message(filters.photo & filters.private)
...
@griffin_bot.on_callback_query(filters.regex("^(approve|reject)_"))
...
@griffin_bot.on_callback_query(filters.regex("^check_otp_"))
...
@griffin_bot.on_callback_query(filters.regex("^login_success$"))
...
@griffin_bot.on_callback_query(filters.regex("^support$"))
...
@griffin_bot.on_callback_query(filters.regex("^recharge$"))
...
@griffin_bot.on_callback_query(filters.regex("^check_balance$"))
...
@griffin_bot.on_callback_query(filters.regex("^buy_whatsapp$"))
...
@griffin_bot.on_message(filters.command("admin") & filters.private)
...
@griffin_bot.on_callback_query(filters.regex("^admin_manage_numbers$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_manage_orders$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_settings$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_reports$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_session_management$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_import_session$"))
...
@griffin_bot.on_callback_query(filters.regex("^import_session_"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_export_session$"))
...
@griffin_bot.on_callback_query(filters.regex("^export_session_"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_delete_session$"))
...
@griffin_bot.on_callback_query(filters.regex("^delete_session_"))
...
@griffin_bot.on_callback_query(filters.regex("^session_login_number$"))
...
@griffin_bot.on_callback_query(filters.regex("^session_import$"))
...
@griffin_bot.on_callback_query(filters.regex("^session_export$"))
...
@griffin_bot.on_callback_query(filters.regex("^session_delete$"))
...
@griffin_bot.on_callback_query(filters.regex("^session_status$"))
...
@griffin_bot.on_message(filters.private & filters.reply & filters.incoming)
...
@griffin_bot.on_callback_query(filters.regex("^admin_back$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_add_number$"))
...
@griffin_bot.on_callback_query(filters.regex("^add_number_type_(telegram|whatsapp)$"))
...
@griffin_bot.on_callback_query(filters.regex("^add_number_(telegram|whatsapp)_(ind|bd|usa|ng|other)$"))
...
@griffin_bot.on_callback_query(filters.regex("^add_number_(telegram|whatsapp)_(ind|bd|usa|ng|other)_(regular|vip)$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_view_numbers$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_pending_orders$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_sales_report$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_bulk_add$"))
...
@griffin_bot.on_message(filters.command("bulkadd") & filters.private)
...
@griffin_bot.on_message(filters.command("exportstring") & filters.private)
...
@griffin_bot.on_message(filters.command("loginnumber") & filters.private)
...
@griffin_bot.on_message(filters.command("deletesession") & filters.private)
...
@griffin_bot.on_message(filters.command("addsession") & filters.private)
...
@griffin_bot.on_callback_query(filters.regex("^verify_success_(.+)$"))
...
@griffin_bot.on_callback_query(filters.regex("^new_otp_(.+)$"))
...
@griffin_bot.on_callback_query(filters.regex("^otp_help$"))
...
@griffin_bot.on_message(filters.command("generateSession") & filters.private)
...
@griffin_bot.on_message(filters.command("entercode") & filters.private)
...
@griffin_bot.on_message(filters.command("enter2fa") & filters.private)
...
@griffin_bot.on_message(filters.command("listnumbers") & filters.private)
...
@griffin_bot.on_message(filters.command("clearinventory") & filters.private)
...
@griffin_bot.on_callback_query(filters.regex("^confirm_clear_all$"))
...
@griffin_bot.on_callback_query(filters.regex("^cancel_clear$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_clear_inventory$"))
...
@griffin_bot.on_message(filters.command("startmonitor") & filters.private)
...
@griffin_bot.on_message(filters.command("stopmonitor") & filters.private)
...
@griffin_bot.on_callback_query(filters.regex("^approve_payment_(.+)_(.+)$"))
...
@griffin_bot.on_callback_query(filters.regex("^copy_upi_id$"))
...
@griffin_bot.on_callback_query(filters.regex("^copy_binance_id$"))
...
@griffin_bot.on_message(filters.text & filters.private)
...
@griffin_bot.on_callback_query(filters.regex("^generate_session_"))
...
@griffin_bot.on_callback_query(filters.regex("^begin_session_"))
...
@griffin_bot.on_callback_query(filters.regex("^confirm_regenerate_"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_generate_session$"))
...
@griffin_bot.on_callback_query(filters.regex("^generate_session_manual$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_monitor_otp$"))
...
@griffin_bot.on_callback_query(filters.regex("^monitor_otp_manual$"))
...
@griffin_bot.on_callback_query(filters.regex("^start_monitor_"))
...
@griffin_bot.on_callback_query(filters.regex("^confirm_monitor_"))
...
@griffin_bot.on_callback_query(filters.regex("^stop_monitor_"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_search_numbers$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_inventory_stats$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_completed_orders$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_revenue_stats$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_customer_list$"))
...
@griffin_bot.on_callback_query(filters.regex("^admin_order_history$"))
...
if __name__ == "__main__":
    initialize_database()
    print("Griffin VIP Bot (TEST BOT) is running...")
    
    async def run_bot():
        await griffin_bot.start()
    ...
    try:
        print("Starting Griffin VIP TEST BOT...")
        griffin_bot.run(run_bot())
